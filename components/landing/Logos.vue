<template>
  <div class="mt-24">
    ...
    >
      ...
      <Icon class="h-8 md:h-12" name="simple-icons:postgresql" size="48" />
      <Icon class="h-8 md:h-12" name="simple-icons:nodedotjs" size="48" />
      <Icon class="h-8 md:h-12" name="simple-icons:react" size="48" />
      <Icon class="h-8 md:h-12" name="simple-icons:arduino" size="48" />
    </div>
  </div>
</template>
